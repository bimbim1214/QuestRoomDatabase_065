...
fun PengelolaHalaman(
    ...
    NavHost(navController = navController, startDestination = DestinasiInsert.route){
        ...
        composable(
            ...
            HomeMhsView(
                onDetailClick = { nim ->
                    navController.navigate("${com.example.pertemuan10.ui.navigation.DestinasiDetail.route}/$nim")
                    kotlin.io.println("PengelolaHalaman: nim = $nim")
                },
                onAddMhs = {
                    navController.navigate(com.example.pertemuan10.ui.view.mahasiswa.DestinasiInsert.route)
                },
                modifier = modifier
            )
        }
